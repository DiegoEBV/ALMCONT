-- Crear tabla rq_sc para relacionar requerimientos con solicitudes de compra
CREATE TABLE IF NOT EXISTS public.rq_sc (
    id UUID DEFAULT extensions.uuid_generate_v4() PRIMARY KEY,
    requerimiento_id UUID NOT NULL REFERENCES public.requerimiento_materiales(id) ON DELETE CASCADE,
...
COMMENT ON TABLE public.rq_sc IS 'Tabla de relación entre requerimientos de materiales y solicitudes de compra';
COMMENT ON COLUMN public.rq_sc.requerimiento_id IS 'ID del requerimiento de material';
